...
<div class="container">
    ...
    <div class="card" style="border-style: solid; border-width: thin; border-color: #FE980F; margin-bottom: 20px;">
        ...
        <a href="#modalKonfirmasiPenerimaan{{ $order->id }}" class="btn btn-primary" data-toggle="modal">Konfirmasi
            Penerimaan</a>

        {{-- Modal Konfirmasi Penerimaan --}}
        <div class="modal fade" id="modalKonfirmasiPenerimaan{{ $order->id }}" tabindex="-1"
            aria-labelledby="modalKonfirmasiPenerimaanLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="modalKonfirmasiPenerimaanLabel">Konfirmasi Penerimaan
                        </h4>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('konfirmasipenerimaan', $order->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary" style="align-self: center">Konfirmasi
                                Penerimaan Produk</button>
                    </div>
                    </form>
                </div>
            </div>
    ...
    {{-- Modal Detail Order --}}
    <div class="modal fade" id="modalDetailOrder{{ $order->id }}" tabindex="-1" aria-labelledby="modalDetailOrderLabel"
        aria-hidden="true">
