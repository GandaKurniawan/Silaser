                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="#"
                                ...
                                SILASER - Sistem Informasi Penjualan dan Layanan Servis Laptop
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            ...
                                            Pembayaran telah dilakukan untuk ID Order #{{ $id }}</h1>
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 19px; margin-top: 0; text-align: justify;">
                                            Mohon untuk segera melakukan pengiriman pesanan Pelanggan</p>
                                        <div class="table"
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box;">
                                        </div>
